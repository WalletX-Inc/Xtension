...
export const LandingTagLines = [
  {
    ...
    description:
      "Access state of the art security by authenticating your wallet and providing consent for transactions using your biometric authentication provided by your own trusted devices.",
    isFinal: false,
  },
  {
