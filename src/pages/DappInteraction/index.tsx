  ...
  return (
    <div className="text-white">
      ...
      <div className="flex justify-end p-2">
        <p className="w-min whitespace-nowrap p-1 px-2 border rounded-full">
      ...
      <div className="py-2 px-4">
        ...
        <p className="p-1 w-min whitespace-nowrap border rounded-sm">
          CONTRACT DEPLOYMENT
        </p>
      </div>
      <hr className="border-slate-600" />
      ...
      <div className="p-3">
        ...
        {gasNotEnoughTxn && (
          <div className=" flex  gap-1 rounded border-l-2 p-2 border-red-600 bg-[#402a2f]">
            ...
            <p>
              You do not have enough SepoliaEth in your account to pay for
              transaction fees on Sepolia network. Deposit SepoliaETH from
              another account.
            </p>
          </div>
        )}
      ...
      <div className="flex pt-0 p-4 pb-2 gap-4">
        <button onClick={handleReject} className="flex-grow border p-2 rounded">
          Reject
        </button>
        <button
      ...
      <p onClick={handleRejectAll} className="text-center text-sm">
